...
public class TcpTextChatBlack {
    ...
    public static void main(String[] argv)
        ...
        TcpTextChatBlack chat = null; // a chat session
        boolean quit = false;
        ...
        TcpTextChatBlack Game = new TcpTextChatBlack();
        Game.showJFrameDemo();
    ...
    TcpTextChatBlack(Socket call, String otherPerson)
    ...
    static TcpTextChatBlack checkIncomingCall()
            throws IOException {
        TcpTextChatBlack chat = null;
        ...
        try {
            ...
            switch (_state) {
                ...
                case idle:
                    chat = new TcpTextChatBlack(connection, _otherPerson);
                    _state = ChatState.chatting;
                    break; // idle
    ...
    static TcpTextChatBlack makeCall(String host) {
        TcpTextChatBlack chat = null;
        Socket call = null;
        String callee = null;
        ...
        if (host != null) {
            ...
            try {
                ...
                chat = new TcpTextChatBlack(call, _otherPerson);
            } // try // try // try // try
            catch (java.net.UnknownHostException e) {
