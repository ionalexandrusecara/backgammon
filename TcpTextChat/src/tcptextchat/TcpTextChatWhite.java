...
public class TcpTextChatWhite {
    ...
    JFrame mainFrame;
    String[] pieceColors = {"b", "n", "n", "n", "n", "w", "n", "w", "n", "n", "n", "b",
        "w", "n", "n", "n", "b", "n", "b", "n", "n", "n", "n", "w"};
    int[] noPieces = {2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, 5, 5, 0, 0, 0, 3,
        0, 5, 0, 0, 0, 0, 2};
    ...
    public static void main(String[] argv)
        ...
        TcpTextChatWhite chat = null; // a chat session
        boolean quit = false;
        ...
        TcpTextChatWhite Game = new TcpTextChatWhite();
        Game.showJFrameDemo();
        while (Game.getNoOfWhites() > 0 || Game.getNoOfBlacks() > 0) {
            ...
            chat.send(Game.dice1 + " " + Game.dice2);
    ...
    TcpTextChatWhite(Socket call, String otherPerson)
    ...
    static TcpTextChatWhite checkIncomingCall()
            throws IOException {
        TcpTextChatWhite chat = null;
        ...
        try {
            ...
            switch (_state) {
                ...
                case idle:
                    chat = new TcpTextChatWhite(connection, _otherPerson);
                    _state = ChatState.chatting;
                    break; // idle
    ...
    static TcpTextChatWhite makeCall(String host) {
        TcpTextChatWhite chat = null;
        Socket call = null;
        String callee = null;
        ...
        if (host != null) {
            ...
            try {
                ...
                chat = new TcpTextChatWhite(call, _otherPerson);
            } // try // try // try // try
            catch (java.net.UnknownHostException e) {
    ...
    public void chooseStart(int i) {
        ...
        if (currentPlayer % 2 == 1 && pieceColors[i - 1].equals("w") && noPieces[i - 1] > 0 && (i > 0) && (i < 25)) {
            ...
            //System.out.println("HERE1111111111111111111111111111111");
    ...
    public void chooseEnd(int i) {
        ...
        if (currentPlayer % 2 == 1 && checkDestinationW(i - 1) && (i > 0) && (i < 25)) {
            ...
            //System.out.println("HERE22222222222222222222222222222");
            JOptionPane.showMessageDialog(null, "Move not allowed!");
        }
